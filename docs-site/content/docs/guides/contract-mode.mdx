...
modules run committed contract batteries derived this way.

Jaunt picks a mode per symbol from the decorator:
...
Contract mode covers top-level functions (sync or async) and whole classes.
