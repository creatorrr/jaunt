...
public-import closure, not unrelated configured sources. Configured ambient `.d.ts`
roots remain available. A broad stable root or glob can therefore remain in
