...
signature/docstring contract, and lists the core design laws the generator is
held to. It adds no model call. Its text is part of the build fingerprint, so
editing it — or overriding it in config — regenerates already-built modules.
