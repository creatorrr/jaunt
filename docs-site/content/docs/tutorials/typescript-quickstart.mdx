...
<Cards>
  <Card title="TypeScript target guide" href="/docs/guides/typescript" description="The full authoring model, workspace routing, classes, contracts, security boundary, and alpha limits." />
