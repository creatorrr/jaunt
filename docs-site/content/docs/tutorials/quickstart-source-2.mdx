...
<Callout type="warning">
  Running this guide drives the OpenAI **Codex CLI** (`codex exec`) and will spend tokens. Make sure the `codex` CLI is installed and you've run `codex login`.
</Callout>
...
Next: [Adding Jaunt To Your Project](/docs/tutorials/adopt-existing).
