...
description: "Spec-driven code generation for Python and TypeScript: write a typed contract, and Jaunt writes the implementation."
---

> *Tyger Tyger, burning bright, / In the forests of the night*
> -- William Blake, via Alfred Bester's *The Stars My Destination*

Jaunt is a CLI for spec-driven code generation in Python and TypeScript. Both targets
are supported. In either language, you write
...
<Cards>
  <Card title="Python quickstart" href="/docs/tutorials/quickstart" description="An empty directory to a generated, tested Python module." />
  <Card title="TypeScript quickstart" href="/docs/tutorials/typescript-quickstart" description="Install @usejaunt/ts, sync the typed boundary, then build and test ordinary TypeScript." />
