...
There's a second, inverse mode too: [`@jaunt.contract`](/docs/guides/contract-mode)
keeps your committed code canonical and derives a committed pytest battery from
...
<Cards>
  <Card title="Quickstart" href="/docs/tutorials/quickstart" />
  <Card title="How It Works" href="/docs/concepts/how-jaunt-works" />
  <Card title="Writing Specs" href="/docs/guides/writing-magic-specs" />
  <Card title="Contract Mode" href="/docs/guides/contract-mode" />
  <Card title="For Coding Agents" href="/docs/guides/coding-agents" />
  <Card title="Codex Engine" href="/docs/concepts/codex-engine" />
</Cards>

Next: [Quickstart](/docs/tutorials/quickstart).
