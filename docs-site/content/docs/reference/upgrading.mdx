...
third-party package source. It still discovers supported static edges, follows manifest
dependencies, and pins every resolved package's full runtime identity through the final
command boundary.
